      ...
      return {
        ...
        animation: {
         ...
         /*       categoryPercentage: 1.0,
          ...
          title: {
              display: true,
              text: 'Соблюдение режима самоизоляции (% жителей, посещающих работу)',
             titleAlign:'left'
          },
          legend: {
            display: true,
 ...
 computed: {
    ...
    methods: {
     fillData () {
        ...
        this.gradient.addColorStop(0, "rgba(230, 122, 14,100)");
        this.gradient.addColorStop(0.5, "rgba(230, 122, 14, 0.75)");
        this.gradient.addColorStop(1, "rgba(230, 122, 14, 0.50)");
        var count = 45000;
        var count2 = 45000;
        this.datacollection = {
          labels: data.reverse(),
